...
<<<<<<< HEAD
	var defaultKey		= 'qwgFCfpFeiKDzZjFlPvLrclFTPKSAKwvOGdhYmZmWFB0ND0g', // Unique master Xively API key to be used as a default
		defaultFeeds	= [119865,'124962!htemp'], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Calum\'s Feeds', // Replaces Xively logo in the header
		dataDuration	= '90days', // Default duration of data to be displayed // ref: https://xively.com/dev/docs/api/data/read/historical_data/
		dataInterval	= 0, // Default interval for data to be displayed (in seconds)
		dataColor		= 'dd0000', // CSS HEX value of color to represent data (omit leading #)
...
>>>>>>> ac6a3432cfff037dc383235b8c44f9e3924b6e08
